...
/**
 * Servlet implementation class Etapa5Servlet
 */
@WebServlet("/Etapa5Servlet")
public class Etapa5Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//Eapapa5 - Ordenação por prioridade - não garante prioridade preferencial, mas faz.
			//Collections.reverse(listaNova);
			
			//Para forçar todos com prioridade = preferencial, basta descomentar e trocar
			//na classe senha de o1 e o2 para o2 e o1
			Collections.sort(listaNova,senha);
